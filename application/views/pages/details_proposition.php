...
<body>
    ...
    <?php } ?>
        ...
        <br>  
    <form method="POST" action="<?php echo base_url('Regime/update_propositionJ1'); ?>">
    ...
    <br>  
    <form method="POST" action="<?php echo base_url('Regime/update_propositionJ2'); ?>">
    ...
    <br>  
    <form method="POST" action="<?php echo base_url('Regime/update_propositionJ3'); ?>">
    ...
    <br>  
    <form method="POST" action="<?php echo base_url('Regime/update_propositionJ4'); ?>">
    ...
    <br>  
    <form method="POST" action="<?php echo base_url('Regime/update_propositionJ5'); ?>">
    ...
    <br>  
    <form method="POST" action="<?php echo base_url('Regime/update_propositionJ6'); ?>">
    ...
    <input type="submit" value="Enregistrer">
        ...
        <br>    
        <form method="POST" action="<?php echo base_url('Regime/update_propositionJ7'); ?>">
        <label for="idplat">Plat du déjeuner:</label>
                        <select id="idplat" name="idplat" required>
                            <option value="">Sélectionnez un plat</option>
                            <?php foreach ($plats as $plat) { ?>
